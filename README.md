...
> Локальный API-сервер для общения с AI-моделями через [duck.ai](https://duck.ai), без необходимости использования браузера.
...
- [Playwright (patchright)](https://github.com/Kaliiiiiiiiii-Vinyzu/patchright) — для автоматизации  (undetected)
- [xvfbwrapper](https://pypi.org/project/xvfbwrapper/) — создаёт виртуальный экран (для headless-работы)
- `notify-send` — Linux-уведомления о статусе
- Основан на [`mrgick/duck_chat`](https://github.com/mrgick/duck_chat)
...
- [mrgick/duck_chat](https://github.com/mrgick/duck_chat) — за основу
- [patchright](https://github.com/Kaliiiiiiiiii-Vinyzu/patchright) — за отличное решение по обходу проверок на ботов
